      ...
      <details>
        ...
        <ul>
          ...
          <li>
            ...
            <code>getStudents</code> function from <code>utils.js</code> file.
            It takes a <code>number</code> parameter that represents how many
            students you want, and returns a <code>Promise</code> that resolves
            to an array of students.
          </li>
          <li>
            ...
            <code>utils.js</code> file. It takes an <code>uuid</code> parameter
            and returns a <code>Promise</code> that resolves to a single
            student. This might code in handy to retrieve the <code>uuid</code>{" "}
            from the URL{" "}
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              href="https://reactrouter.com/en/6.8.1/hooks/use-params"
            >
              useParams
            </a>
          </li>
